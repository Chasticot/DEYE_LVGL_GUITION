...
void ui_registers_create() {
  ...
  add_reg_line(cont, "GEN Power", &ta_gen_power, 166, &ta_coeff_gen_power, -1.0f, y); y += step;
  ...
  add_reg_line(cont, "SmartLoad", &ta_smartload, 195, &ta_smartload_bit, 0.0f, y, true); y += step;
  ...
  lv_obj_add_event_cb(default_btn, [](lv_event_t *e) {
    ...
    lv_textarea_set_text(ta_gen_power, "166");
    ...
    lv_textarea_set_text(ta_smartload_bit, "0");
