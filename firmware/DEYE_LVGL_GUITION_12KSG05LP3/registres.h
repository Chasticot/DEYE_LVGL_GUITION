...
// =============================================
// MODÈLE : DEYE SUN-12K-SG05LP3-EU-SM2
// =============================================
// Cartographie triphase basse tension issue du protocole Deye V1.04.
// Le registre PV3 existe dans le protocole generique, mais ce modele a 2 MPPT.
const InverterRegisters deye_hybrid = {
  ...
  .block2_start = 552,
  .block2_count = 123   // 552 a 674, limite FC03 respectee
};
