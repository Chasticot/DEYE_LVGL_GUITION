...
static constexpr bool DEYE_SG05_EV_SUPPORTED = false;
...
static void settings_load_ev_registers() {
  ...
  // R489/R490 sur SG05LP3 : ces adresses sont des parametres LVRT/HVRT.
...
static bool settings_save_tempo(bool enabled, bool colorblind, bool ev_charger) {
  if (!DEYE_SG05_EV_SUPPORTED) ev_charger = false;
...
static void settings_load() {
  ...
  cfg_ev_charger_enabled = DEYE_SG05_EV_SUPPORTED && preferences.getBool(SETTINGS_KEY_EV_CHARGER, false);
