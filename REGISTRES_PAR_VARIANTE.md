...
Les adresses SG05LP3 et HP3 proviennent de la cartographie Deye utilisée par ces deux projets ; elles sont indiquées en italique tant que leur comportement n'a pas été vérifié sur les onduleurs correspondants. Pour l'AI-W5.1 ESS, la cartographie est explicitement provisoire : **aucune adresse n'est encore confirmée pour ce profil**. Les adresses non italiques du 12K-SG02LP1 correspondent au profil indiqué comme validé dans le code ; la variante VETRONIC reprend exactement cette cartographie Deye.
